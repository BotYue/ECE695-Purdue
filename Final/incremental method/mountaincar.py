...
featurizer = sklearn.pipeline.FeatureUnion([
        ("rbf1", RBFSampler(gamma=0.2, n_components=1000)),
        ("rbf2", RBFSampler(gamma=0.5, n_components=1000)),
        ("rbf3", RBFSampler(gamma=1, n_components=1000)),
        ("rbf4", RBFSampler(gamma=2, n_components=1000)),
        ("rbf5", RBFSampler(gamma=5, n_components=1000))
        ])
...
class Estimator():
    ...
    def update(self, s, a, y):
        ...
        #print self.models[a].score(X, Y)
        #print (self.models[a].coef_ )
        #print whatheck
...
stats = q_learning(env, estimator,800, epsilon=0.1)
end_time1 = start_time1-time.time()
#plotting.plot_cost_to_go_mountain_car(env, estimator)
estimator2 = Estimator('l1',0.1)
start_time2 = time.time()
stats2 = q_learning(env, estimator2, 800, epsilon=0.1)
end_time2 = start_time2-time.time()

estimator3 = Estimator('l1',0.01)
start_time3 = time.time()
stats3 = q_learning(env, estimator3, 800, epsilon=0.1)
...
plt.legend(('lambda=1', 'lambda=0.1', 'lambda=0.01'))

plt.xlabel("Episode")
plt.ylabel("Episode Reward (Smoothed)")
plt.title("Episode Reward in MountainCar Domain")
plt.show()
